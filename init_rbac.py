...
PERMISSIONS = [
    # ========== 用户管理权限 ==========
    {
        "id": 1,
        "name": "获取当前用户信息",
        "api_path": "/api/admin/admin_users/me",
        "remark": "获取当前登录用户信息",
        "status": 1
    },
    {
        "id": 2,
        "name": "更新当前用户信息",
        "api_path": "/api/admin/admin_users/me/update",
        "remark": "更新当前登录用户信息",
        "status": 1
    },
    {
        "id": 3,
        "name": "修改密码",
        "api_path": "/api/admin/admin_users/me/change-password",
        "remark": "修改当前用户密码",
        "status": 1
    },
    {
        "id": 4,
        "name": "获取用户列表",
        "api_path": "/api/admin/admin_users/list",
        "remark": "获取管理员用户列表",
        "status": 1
    },
    {
        "id": 5,
        "name": "获取用户详情",
        "api_path": "/api/admin/admin_users/detail/*",
        "remark": "获取指定用户详情",
        "status": 1
    },
    {
        "id": 6,
        "name": "创建用户",
        "api_path": "/api/admin/admin_users/create",
        "remark": "创建管理员用户",
        "status": 1
    },
    {
        "id": 7,
        "name": "更新用户",
        "api_path": "/api/admin/admin_users/update/*",
        "remark": "更新管理员用户信息",
        "status": 1
    },
    {
        "id": 8,
        "name": "删除用户",
        "api_path": "/api/admin/admin_users/delete/*",
        "remark": "删除管理员用户",
        "status": 1
    },
    {
        "id": 9,
        "name": "为用户分配角色",
        "api_path": "/api/admin/admin_users/assign-roles/*",
        "remark": "为用户分配角色",
        "status": 1
    },
    {
        "id": 10,
        "name": "获取用户角色",
        "api_path": "/api/admin/admin_users/roles/*",
        "remark": "获取用户的角色列表",
        "status": 1
    },
    {
        "id": 11,
        "name": "设置用户权限覆盖",
        "api_path": "/api/admin/admin_users/permission-overrides/*",
        "remark": "批量设置用户权限覆盖（POST）",
        "status": 1
    },
    {
        "id": 12,
        "name": "设置用户菜单覆盖",
        "api_path": "/api/admin/admin_users/menu-overrides/*",
        "remark": "批量设置用户菜单覆盖（POST）",
        "status": 1
    },
    ...
    },
    {
        "id": 21,
        "name": "获取角色详情",
        "api_path": "/api/admin/roles/detail/*",
        "remark": "获取指定角色详情",
        "status": 1
    },
    {
        "id": 22,
        "name": "创建角色",
        "api_path": "/api/admin/roles/create",
        "remark": "创建角色",
        "status": 1
    },
    {
        "id": 23,
        "name": "更新角色",
        "api_path": "/api/admin/roles/update/*",
        "remark": "更新角色信息",
        "status": 1
    },
    {
        "id": 24,
        "name": "删除角色",
        "api_path": "/api/admin/roles/delete/*",
        "remark": "删除角色",
        "status": 1
    },
    {
        "id": 25,
        "name": "为角色分配权限",
        "api_path": "/api/admin/roles/assign-permissions/*",
        "remark": "为角色分配权限",
        "status": 1
    },
    {
        "id": 26,
        "name": "为角色分配菜单",
        "api_path": "/api/admin/roles/assign-menus/*",
        "remark": "为角色分配菜单",
        "status": 1
    },
    {
        "id": 27,
        "name": "获取角色权限",
        "api_path": "/api/admin/roles/permissions/*",
        "remark": "获取角色的权限列表",
        "status": 1
    },
    {
        "id": 28,
        "name": "获取角色菜单",
        "api_path": "/api/admin/roles/menus/*",
        "remark": "获取角色的菜单列表",
        "status": 1
    },
    ...
    # ========== 权限管理权限 ==========
    {
        "id": 30,
        "name": "获取权限列表",
        "api_path": "/api/admin/permissions/list",
        "remark": "获取权限列表",
        "status": 1
    },
    {
        "id": 31,
        "name": "获取权限详情",
        "api_path": "/api/admin/permissions/detail/*",
        "remark": "获取指定权限详情",
        "status": 1
    },
    {
        "id": 32,
        "name": "创建权限",
        "api_path": "/api/admin/permissions/create",
        "remark": "创建权限",
        "status": 1
    },
    {
        "id": 33,
        "name": "更新权限",
        "api_path": "/api/admin/permissions/update/*",
        "remark": "更新权限信息",
        "status": 1
    },
    {
        "id": 34,
        "name": "删除权限",
        "api_path": "/api/admin/permissions/delete/*",
        "remark": "删除权限",
        "status": 1
    },
    ...
    },
    {
        "id": 42,
        "name": "获取菜单详情",
        "api_path": "/api/admin/menus/detail/*",
        "remark": "获取指定菜单详情",
        "status": 1
    },
    {
        "id": 43,
        "name": "创建菜单",
        "api_path": "/api/admin/menus/create",
        "remark": "创建菜单",
        "status": 1
    },
    {
        "id": 44,
        "name": "更新菜单",
        "api_path": "/api/admin/menus/update/*",
        "remark": "更新菜单信息",
        "status": 1
    },
    {
        "id": 45,
        "name": "删除菜单",
        "api_path": "/api/admin/menus/delete/*",
        "remark": "删除菜单",
        "status": 1
    },
    ...
    },
    {
        "id": 51,
        "name": "获取日志详情",
        "api_path": "/api/admin/logs/detail/*",
        "remark": "获取指定日志详情",
        "status": 1
    },
    {
    ...
    },
    {
        "id": 53,
        "name": "获取日志统计",
        "api_path": "/api/admin/logs/statistics",
        "remark": "获取API日志统计信息",
        "status": 1
    },
    {
        "id": 54,
        "name": "清理旧日志",
        "api_path": "/api/admin/logs/cleanup",
        "remark": "清理旧日志",
        "status": 1
    },
]
